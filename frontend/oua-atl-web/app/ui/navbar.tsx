...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div className="flex z-90 w-full bg-gradient-to-r from-white via-orange-50 to-blue-50 h-20 md:justify-around p-4 md:px-0 px-3 justify-between items-center">
            ...
            <li
              ...
              className={`${
                currentItem === item
                  ...
                  : ""
              } text-sm animate-item px-4 py-2`}
            >
              <Link
                href={
                  [
