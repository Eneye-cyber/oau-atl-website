...
export default function AboutPage() {
  ...
  const hero = pageData.sections.find(
    (item) => item.slug === "about-hero-section"
  );
  const mainContent = pageData.sections.find(
    (item) => item.slug === "about-page-mid-section"
  );
  const executive = pageData.sections.find(
    (item) => item.slug === "executive-section"
  );
  const contact = pageData.sections.find(
    (item) => item.slug === "contact-section"
  );
    ...
    <div className="flex flex-col min-h-screen">
      <article className="flex-1">
        ...
        <section className="w-full py-12 md:py-20 lg:py-24 bg-gray-100 dark:bg-gray-800">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-8 lg:mb-16">
